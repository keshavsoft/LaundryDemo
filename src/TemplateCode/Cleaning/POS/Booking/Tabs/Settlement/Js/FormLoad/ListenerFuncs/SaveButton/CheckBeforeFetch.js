let StartFunc = () => {
    let jVarLocalCashAmount= parseInt(jFLocalCashAmountId());
    let jVarLocalCardAmount= parseInt(jFLocalCardAmountId());
    let jVarLocalUPIAmount=  parseInt(jFLocalUPIAmountId());
    let jVarLocalOrderAmount= parseInt(jFLocalOrderAmountId());
